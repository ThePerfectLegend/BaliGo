...
var birdPark = Landmark(
    ...
    """,
    shortDescription: "Туристическая достопримечательность в районе Gianyar. На площади 2000 квадратных метров расположен заповедник, в котором проходят шоу с экзотическими птицами",
    island: .Bali,
    region: .Gianyar,
    subRegion: .Sukawati,
    state: "Batubulan",
